		...
		options = {
			...
			{	--General HUD
				...
				options = {
					...
					-- 	value = {"CustomHUD", "WolfENABLED"},
					-- 	visible_reqs = {}, enabled_reqs = {},
					-- },
					{
						type = "multi_choice",
						name_id = "wolfhud_hud_type_title",
						desc_id = "wolfhud_hud_type_desc",
						options = {
							"wolfhud_use_vanilla",
							"wolfhud_use_vanillahud_extras_title",
							"wolfhud_use_customhud_title"
						},
						visible_reqs = {}, enabled_reqs = {},
						value = {"CustomHUD", "HUDTYPE"},
					},
					{
						type = "toggle",
					...
					},
					{
						...
						visible_reqs = {
							{ setting = {"CustomHUD", "HUDTYPE"}, equal = 3 }
						},
						enabled_reqs = {
							{ setting = {"CustomHUD", "HUDTYPE"}, equal = 3 }
						},
					...
					{	--CustomHUD Player
						...
						options = {
							...
							{
								type = "toggle",
								name_id = "wolfhud_panels_show_new_downcounter_title",
								desc_id = "wolfhud_panels_show_new_downcounter_desc",
								visible_reqs = {
									{ setting = {"CustomHUD", "HUDTYPE"}, min = 2, max = 2 },
								},
								enabled_reqs = {
									{ setting = {"CustomHUD", "HUDTYPE"}, min = 2, max = 2 },
								},
							...
							},
							{
								...
								visible_reqs = {
									{ setting = {"CustomHUD", "HUDTYPE"}, equal = 2 }
								},
								enabled_reqs = {
									{ setting = {"CustomHUD", "HUDTYPE"}, equal = 2 }
								},
							...
							-- {
							-- 	type = "toggle",
							-- 	name_id = "wolfhud_panels_health_armor_num_title",
							-- 	desc_id = "wolfhud_panels_health_armor_num_desc",
							-- 	visible_reqs = {},
							-- 	enabled_reqs = {
							-- 		{ setting = {"CustomHUD", "ENABLED"}, invert = false }
							-- 	},
							-- 	value = {"CustomHUD", "PLAYER", "SHOW_HP_AP_NUM"},
							-- },
							-- {
							-- 	type = "toggle",
							-- 	name_id = "wolfhud_panels_hide_health_armor_title",
							-- 	desc_id = "wolfhud_panels_hide_health_armor_desc",
							-- 	visible_reqs = {},
							-- 	enabled_reqs = {
							-- 		{ setting = {"CustomHUD", "ENABLED"}, invert = false }
							-- 	},
							-- 	value = {"CustomHUD", "PLAYER", "HIDEHPAP"},
							-- },
							{
								type = "multi_choice",
					...
					{	--CustomHUD Teammate
						...
						options = {
							...
							-- 		{ setting = {"CustomHUD", "ENABLED"}, invert = false }
							-- 	},
							-- 	value = {"CustomHUD", "TEAMMATE", "SHOW_HP_AP_NUM"},
							-- },
							-- {
							-- 	type = "toggle",
							-- 	name_id = "wolfhud_panels_hide_health_armor_title",
							...
							-- 		{ setting = {"CustomHUD", "ENABLED"}, invert = false }
							-- 	},
							-- 	value = {"CustomHUD", "TEAMMATE", "HIDEHPAP"},
							-- },
							{
								type = "multi_choice",
								name_id = "wolfhud_panels_condition_icon_color_title",
					...
					},
					{
						...
						options = {
							...
							},
							{
								...
								visible_reqs = {}, enabled_reqs = {},
								value = {"MISCHUD", "JOKER_CONTOUR_NEW"},
							},
							{
								type = "toggle",
							...
							{
								type = "slider",
								name_id = "wolfhud_sub_height_title",
								desc_id = "wolfhud_sub_height_desc",
								visible_reqs = {},
								enabled_reqs = {},
								value = {"MISCHUD", "SUB_HEIGHT"},
								min_value = 0,
								max_value = 800,
								step_size = 1,						
							},
							...
							{
								type = "toggle",
								name_id = "wolfhud_shoot_through_bots_title",
								desc_id = "wolfhud_shoot_through_bots_desc",
								value = {"MISCHUD", "SHOOT_THROUGH_BOTS"},
								visible_reqs = {}, enabled_reqs = {},
							},
						},
					},
					...
					{	--Chat
						...
						options = {
							...
							{
								type = "slider",
								name_id = "wolfhud_chat_y_pos_title",
								desc_id = "wolfhud_chat_y_pos_desc",
								visible_reqs = {
								    { setting = {"HUDChat", "ENABLED"}, invert = false }
								},
								enabled_reqs = {
							...
							{
								type = "slider",
								name_id = "wolfhud_chat_x_pos_title",
								desc_id = "wolfhud_chat_x_pos_desc",
								visible_reqs = {
								    { setting = {"HUDChat", "ENABLED"}, invert = false }
								},
								enabled_reqs = {
					...
					{ -- AssaultBanner
						...
						options = {
							...
							{
								type = "toggle",
								name_id = "wolfhud_hide_casing_title",
								desc_id = "wolfhud_hide_casing_desc",
								visible_reqs = {}, enabled_reqs = {},
								value = {"AssaultBanner", "HIDE_CASING_MODE_PANEL"},
							}
						},
					},
					{ -- Damage Indicator
						...
						options = {
							{
								...
								value = {"DamagePopupNew", "DISPLAY_MODE"},
								visible_reqs = {}, enabled_reqs = {},
								options = {
							...
							},
							{
								...
								visible_reqs = {}, enabled_reqs = {},
								value = {"DamagePopupNew", "SHOW_DAMAGE_POPUP_ALT"},
							},
							{
								type = "toggle",
								name_id = "wolfhud_dmg_popup_show_damage_per_hit",
								desc_id = "wolfhud_dmg_popup_show_damage_per_hit_desc",
								visible_reqs = {
								    { setting = { "DamagePopupNew", "SHOW_DAMAGE_POPUP_ALT" }, invert = false }
								},
								enabled_reqs = {
									{ setting = { "DamagePopupNew", "SHOW_DAMAGE_POPUP_ALT" }, invert = false },
								},
								value = {"DamagePopupNew", "SHOW_DAMAGE_PER_HIT"},								
							},
							{
								type = "toggle",
								name_id = "wolfhud_dmg_popup_show_rainbow_popups",
								desc_id = "wolfhud_dmg_popup_show_rainbow_popups_desc",
								visible_reqs = {
								    { setting = { "DamagePopupNew", "SHOW_DAMAGE_POPUP_ALT" }, invert = false }
								},
								enabled_reqs = {
								...
								value = {"DamagePopupNew", "SHOW_RAINBOW_POPUPS"},								
							},
							{
								type = "slider",
							...
							{
								type = "slider",
								name_id = "wolfhud_dmg_popup_damage_vert_offset",
								desc_id = "wolfhud_dmg_popup_damage_vert_offset_desc",
								visible_reqs = {
									{ setting = { "DamagePopupNew", "SHOW_DAMAGE_POPUP_ALT" }, invert = false }
								},
								enabled_reqs = {
								...
								value = {"DamagePopupNew", "DAMAGE_VERT_OFFSET"},
								min_value = 0,
								max_value = 300,
								step_size = 1,
							},
							{
								type = "slider",
								name_id = "wolfhud_dmg_popup_damage_kill_flash_spd",
								desc_id = "wolfhud_dmg_popup_damage_kill_flash_spd_desc",
								visible_reqs = {
									{ setting = { "DamagePopupNew", "SHOW_DAMAGE_POPUP_ALT" }, invert = false }
								},
								enabled_reqs = {
								...
								value = {"DamagePopupNew", "DAMAGE_KILL_FLASH_SPD"},
								min_value = 1,
								max_value = 10,
								step_size = 1,
							},
							{
								type = "slider",
								name_id = "wolfhud_dmg_popup_hit_chg_per_tick",
								desc_id = "wolfhud_dmg_popup_hit_chg_per_tick_desc",
								visible_reqs = {
									{ setting = { "DamagePopupNew", "SHOW_DAMAGE_POPUP_ALT" }, invert = false }
								},
								enabled_reqs = {
								...
								value = {"DamagePopupNew", "HIT_CHG_PER_TICK"},
								min_value = 0.1,
								max_value = 2,
								step_size = 0.1,
							},
							{
								type = "slider",
								name_id = "wolfhud_dmg_popup_fatal_hit_chg_per_tick",
								desc_id = "wolfhud_dmg_popup_fatal_hit_chg_per_tick_desc",
								visible_reqs = {
									{ setting = { "DamagePopupNew", "SHOW_DAMAGE_POPUP_ALT" }, invert = false }
								},
								enabled_reqs = {
								...
								value = {"DamagePopupNew", "FATAL_HIT_CHG_PER_TICK"},
								min_value = 0,
								max_value = 2,
								step_size = 0.01,
							},
							...
							},
							{
								...
								value = {"DamagePopupNew", "HEADSHOT_COLOR"},
								visible_reqs = {}, enabled_reqs = {},
								options = {},
								add_color_options = true,
								add_rainbow = false,
							},
							{
								...
								value = {"DamagePopupNew", "GLOW_COLOR"},
								visible_reqs = {
								    { setting = { "DamagePopupNew", "SHOW_DAMAGE_POPUP_ALT" }, invert = false }
								},
								enabled_reqs = {
							...
							{
								type = "slider",
								name_id = "wolfhud_dmg_popup_scale_alt_title",
								desc_id = "wolfhud_dmg_popup_scale_alt_desc",
								visible_reqs = {
									{ setting = { "DamagePopupNew", "DISPLAY_MODE" }, min = 2 },
								},
								enabled_reqs = {
									{ setting = { "DamagePopupNew", "DISPLAY_MODE" }, min = 2 },
								},
								value = {"DamagePopupNew", "SCALE_ALT"},
								min_value = 0.1,
								max_value = 3,
								step_size = 0.1,
							},
							{
								...
								value = {"DamagePopupNew", "SKULL_SCALE"},
								min_value = 0.1,
								max_value = 3,
								step_size = 0.1,
							},
							{
								...
								value = {"DamagePopupNew", "SKULL_ALIGN"},
								visible_reqs = {
									{ setting = { "DamagePopupNew", "DISPLAY_MODE" }, min = 2 },
								},
								enabled_reqs = {
							...
							},
							{
								...
								value = {"DamagePopupNew", "CRITICAL_COLOR"},
								visible_reqs = {
									{ setting = { "DamagePopupNew", "DISPLAY_MODE" }, min = 2, max = 2 },
								},
								enabled_reqs = {
									{ setting = { "DamagePopupNew", "DISPLAY_MODE" }, min = 2, max = 2 },
								},
			...
			{	--HUDList
				...
				options = {
					...
					{
						type = "toggle",
						name_id = "wolfhud_pd2stylebox_title",
						desc_id = "wolfhud_pd2stylebox_desc",
						value = {"HUDList", "PD2StyleBox"},
						visible_reqs = {}, enabled_reqs = {},
					},
					{
						type = "toggle",
					...
					{
						type = "toggle",
						name_id = "wolfhud_enable_bg_title",
						desc_id = "wolfhud_enable_bg_desc",
						value = {"HUDList", "ENABLE_BG"},
						visible_reqs = {}, 
						enabled_reqs = {
						    { setting = { "HUDList", "ENABLED" }, invert = false },
						},						
					...
					{
						type = "slider",
						name_id = "wolfhud_hudlist_buff_list_x_offset_title",
						desc_id = "wolfhud_hudlist_buff_list_x_offset_desc",
						value = {"HUDList", "buff_list_x_offset"},
						visible_reqs = {},
								enabled_reqs = {
							{ setting = { "HUDList", "ENABLED" }, invert = false },
						},
					...
					{
						type = "slider",
						name_id = "wolfhud_hudlist_right_list_bg_alpha_title",
						desc_id = "wolfhud_hudlist_right_list_bg_alpha_desc",
						value = {"HUDList", "right_list_bg_alpha"},
						visible_reqs = {},
						enabled_reqs = {
							{ setting = { "HUDList", "ENABLED" }, invert = false },
						},
					...
					{
						type = "slider",
						name_id = "wolfhud_hudlist_left_list_bg_alpha_title",
						desc_id = "wolfhud_hudlist_left_list_bg_alpha_desc",
						value = {"HUDList", "left_list_bg_alpha"},
						visible_reqs = {},
						enabled_reqs = {
							{ setting = { "HUDList", "ENABLED" }, invert = false },
						},
					...
					{	--HUDList Color Options
						type = "menu",
						menu_id = "wolfhud_hudlist_color_options_menu",
						name_id = "wolfhud_infopanels_color_options_name",
						desc_id = "wolfhud_infopanels_color_options_help",
						options = {
							{
								type = "multi_choice",
							...
							{
								type = "multi_choice",
								name_id = "wolfhud_hudlist_guard_color_title",
								desc_id = "wolfhud_hudlist_guard_color_desc",
								value = {"HUDList", "guard_color"},
								visible_reqs = {},
								enabled_reqs = {
									{ setting = { "HUDList", "ENABLED" }, invert = false },
								},
							...
							{
								type = "multi_choice",
								name_id = "wolfhud_hudlist_turret_color_title",
								desc_id = "wolfhud_hudlist_turret_color_desc",
								value = {"HUDList", "turret_color"},
								visible_reqs = {},
								enabled_reqs = {
									{ setting = { "HUDList", "ENABLED" }, invert = false },
								},
							...
							{
								type = "multi_choice",
								name_id = "wolfhud_hudlist_shield_color_title",
								desc_id = "wolfhud_hudlist_shield_color_desc",
								value = {"HUDList", "shield_color"},
								visible_reqs = {},
								enabled_reqs = {
									{ setting = { "HUDList", "ENABLED" }, invert = false },
								},
							...
							{
								type = "multi_choice",
								name_id = "wolfhud_hudlist_tank_color_title",
								desc_id = "wolfhud_hudlist_tank_color_desc",
								value = {"HUDList", "tank_color"},
								visible_reqs = {},
								enabled_reqs = {
									{ setting = { "HUDList", "ENABLED" }, invert = false },
								},
							...
							{
								type = "multi_choice",
								name_id = "wolfhud_hudlist_sniper_color_title",
								desc_id = "wolfhud_hudlist_sniper_color_desc",
								value = {"HUDList", "sniper_color"},
								visible_reqs = {},
								enabled_reqs = {
									{ setting = { "HUDList", "ENABLED" }, invert = false },
								},
							...
							{
								type = "multi_choice",
								name_id = "wolfhud_hudlist_spooc_color_title",
								desc_id = "wolfhud_hudlist_spooc_color_desc",
								value = {"HUDList", "spooc_color"},
								visible_reqs = {},
								enabled_reqs = {
									{ setting = { "HUDList", "ENABLED" }, invert = false },
								},
							...
							{
								type = "multi_choice",
								name_id = "wolfhud_hudlist_taser_color_title",
								desc_id = "wolfhud_hudlist_taser_color_desc",
								value = {"HUDList", "taser_color"},
								visible_reqs = {},
								enabled_reqs = {
									{ setting = { "HUDList", "ENABLED" }, invert = false },
								},
							...
							{
								type = "multi_choice",
								name_id = "wolfhud_hudlist_medic_color_title",
								desc_id = "wolfhud_hudlist_medic_color_desc",
								value = {"HUDList", "medic_color"},
								visible_reqs = {},
								enabled_reqs = {
									{ setting = { "HUDList", "ENABLED" }, invert = false },
								},
							...
							{
								type = "multi_choice",
								name_id = "wolfhud_hudlist_phalanx_color_title",
								desc_id = "wolfhud_hudlist_phalanx_color_desc",
								value = {"HUDList", "phalanx_color"},
								visible_reqs = {},
								enabled_reqs = {
									{ setting = { "HUDList", "ENABLED" }, invert = false },
								},
							...
							{
								type = "multi_choice",
								name_id = "wolfhud_hudlist_jokers_color_title",
								desc_id = "wolfhud_hudlist_jokers_color_desc",
								value = {"HUDList", "jokers_color"},
								visible_reqs = {},
								enabled_reqs = {
									{ setting = { "HUDList", "ENABLED" }, invert = false },
								},
							...
							-- {
							-- 	type = "multi_choice",
							-- 	name_id = "wolfhud_hudlist_pagers_color_title",
							-- 	desc_id = "wolfhud_hudlist_pagers_color_desc",
							-- 	value = {"HUDList", "pagers_color"},
							-- 	visible_reqs = {},
							-- 	enabled_reqs = {
							-- 		{ setting = { "HUDList", "ENABLED" }, invert = false },
							-- 	},
							...
							-- {
							-- 	type = "multi_choice",
							-- 	name_id = "wolfhud_hudlist_cam_color_title",
							-- 	desc_id = "wolfhud_hudlist_cam_color_desc",
							-- 	value = {"HUDList", "cam_color"},
							-- 	visible_reqs = {},
							-- 	enabled_reqs = {
							-- 		{ setting = { "HUDList", "ENABLED" }, invert = false },
							-- 	},
							...
							-- {
							-- 	type = "multi_choice",
							-- 	name_id = "wolfhud_hudlist_bodybags_color_title",
							-- 	desc_id = "wolfhud_hudlist_bodybags_color_desc",
							-- 	value = {"HUDList", "bodybags_color"},
							-- 	visible_reqs = {},
							-- 	enabled_reqs = {
							-- 		{ setting = { "HUDList", "ENABLED" }, invert = false },
							-- 	},
							...
							-- {
							-- 	type = "multi_choice",
							-- 	name_id = "wolfhud_hudlist_corpse_color_title",
							-- 	desc_id = "wolfhud_hudlist_corpse_color_desc",
							-- 	value = {"HUDList", "corpse_color"},
							-- 	visible_reqs = {},
							-- 	enabled_reqs = {
							-- 		{ setting = { "HUDList", "ENABLED" }, invert = false },
							-- 	},
							...
							-- {
							-- 	type = "multi_choice",
							-- 	name_id = "wolfhud_hudlist_loot_color_title",
							-- 	desc_id = "wolfhud_hudlist_loot_color_desc",
							-- 	value = {"HUDList", "loot_color"},
							-- 	visible_reqs = {},
							-- 	enabled_reqs = {
							-- 		{ setting = { "HUDList", "ENABLED" }, invert = false },
							-- 	},
							...
							-- {
							-- 	type = "multi_choice",
							-- 	name_id = "wolfhud_hudlist_special_items_color_title",
							-- 	desc_id = "wolfhud_hudlist_special_items_color_desc",
							-- 	value = {"HUDList", "special_items_color"},
							-- 	visible_reqs = {},
							-- 	enabled_reqs = {
							-- 		{ setting = { "HUDList", "ENABLED" }, invert = false },
							-- 	},
							...
							{
								type = "multi_choice",
								name_id = "wolfhud_hudlist_left_box_color_title",
								desc_id = "wolfhud_hudlist_left_box_color_desc",
								value = {"HUDList", "left_list_color"},
								visible_reqs = {},
								enabled_reqs = {
									{ setting = { "HUDList", "ENABLED" }, invert = false },
								},
							...
							{
								type = "multi_choice",
								name_id = "wolfhud_hudlist_left_box_bg_color_title",
								desc_id = "wolfhud_hudlist_left_box_bg_color_desc",
								value = {"HUDList", "left_list_color_bg"},
								visible_reqs = {},
								enabled_reqs = {
									{ setting = { "HUDList", "ENABLED" }, invert = false },
								},
							...
							{
								type = "multi_choice",
								name_id = "wolfhud_hudlist_timers_color_title",
								desc_id = "wolfhud_hudlist_timers_color_desc",
								value = {"HUDList", "timers_color"},
								visible_reqs = {},
								enabled_reqs = {
									{ setting = { "HUDList", "ENABLED" }, invert = false },
								},
							...
							-- {
							-- 	type = "multi_choice",
							-- 	name_id = "wolfhud_hudlist_equipment_color_title",
							-- 	desc_id = "wolfhud_hudlist_equipment_color_desc",
							-- 	value = {"HUDList", "equipment_color"},
							-- 	visible_reqs = {},
							-- 	enabled_reqs = {
							-- 		{ setting = { "HUDList", "ENABLED" }, invert = false },
							-- 	},
							...
							{
								type = "multi_choice",
								name_id = "wolfhud_hudlist_minions_info_color_title",
								desc_id = "wolfhud_hudlist_minions_info_color_desc",
								value = {"HUDList", "minions_info_color"},
								visible_reqs = {},
								enabled_reqs = {
									{ setting = { "HUDList", "ENABLED" }, invert = false },
								},
							...
							{
								type = "multi_choice",
								name_id = "wolfhud_hudlist_pagers_timer_color_title",
								desc_id = "wolfhud_hudlist_pagers_timer_color_desc",
								value = {"HUDList", "pagers_timer_color"},
								visible_reqs = {},
								enabled_reqs = {
									{ setting = { "HUDList", "ENABLED" }, invert = false },
								},
							...
							{
								type = "multi_choice",
								name_id = "wolfhud_hudlist_ecms_color_title",
								desc_id = "wolfhud_hudlist_ecms_color_desc",
								value = {"HUDList", "ecms_color"},
								visible_reqs = {},
								enabled_reqs = {
									{ setting = { "HUDList", "ENABLED" }, invert = false },
								},
							...
							{
								type = "multi_choice",
								name_id = "wolfhud_hudlist_ecm_feedback_color_title",
								desc_id = "wolfhud_hudlist_ecm_feedback_color_desc",
								value = {"HUDList", "ecm_feedback_color"},
								visible_reqs = {},
								enabled_reqs = {
									{ setting = { "HUDList", "ENABLED" }, invert = false },
								},
							...
							{
								type = "multi_choice",
								name_id = "wolfhud_hudlist_tape_loop_color_title",
								desc_id = "wolfhud_hudlist_tape_loop_color_desc",
								value = {"HUDList", "tape_loop_color"},
								visible_reqs = {},
								enabled_reqs = {
									{ setting = { "HUDList", "ENABLED" }, invert = false },
								},
							...
							{
								type = "multi_choice",
								name_id = "wolfhud_hudlist_buff_icon_color_standard_title",
								desc_id = "wolfhud_hudlist_buff_icon_color_standard_desc",
								value = {"HUDList", "buff_icon_color_standard"},
								visible_reqs = {},
								enabled_reqs = {
									{ setting = { "HUDList", "ENABLED" }, invert = false },
								},
							...
							{
								type = "multi_choice",
								name_id = "wolfhud_hudlist_buff_icon_color_buff_title",
								desc_id = "wolfhud_hudlist_buff_icon_color_buff_desc",
								value = {"HUDList", "buff_icon_color_buff"},
								visible_reqs = {},
								enabled_reqs = {
									{ setting = { "HUDList", "ENABLED" }, invert = false },
								},
							...
							{
								type = "multi_choice",
								name_id = "wolfhud_hudlist_buff_icon_color_debuff_title",
								desc_id = "wolfhud_hudlist_buff_icon_color_debuff_desc",
								value = {"HUDList", "buff_icon_color_debuff_fix"},
								visible_reqs = {},
								enabled_reqs = {
									{ setting = { "HUDList", "ENABLED" }, invert = false },
								},
							...
							{
								type = "multi_choice",
								name_id = "wolfhud_hudlist_buff_icon_color_team_title",
								desc_id = "wolfhud_hudlist_buff_icon_color_team_desc",
								value = {"HUDList", "buff_icon_color_team_fix"},
								visible_reqs = {},
								enabled_reqs = {
									{ setting = { "HUDList", "ENABLED" }, invert = false },
								},
					...
					{	--HUDList Left List
						...
						options = {
							...
							{
								type = "toggle",
								name_id = "wolfhud_hudlist_show_jokers_health_bar_title",
								desc_id = "wolfhud_hudlist_show_jokers_health_bar_desc",
								value = {"HUDList", "LEFT_LIST", "show_jokers_health_bar"},
								visible_reqs = {},
								enabled_reqs = {
									{ setting = { "HUDList", "ENABLED" }, invert = false },
								},
							...
							{
								type = "toggle",
								name_id = "wolfhud_hudlist_show_jokers_kill_counter_title",
								desc_id = "wolfhud_hudlist_show_jokers_kill_counter_desc",
								value = {"HUDList", "LEFT_LIST", "show_jokers_kill_counter"},
								visible_reqs = {},
								enabled_reqs = {
									{ setting = { "HUDList", "ENABLED" }, invert = false },
								},
					...
					{	--HUDList Right List
						...
						options = {
							...
							-- {
							-- 	type = "toggle",
							-- 	name_id = "wolfhud_hudlist_show_aggregate_and_total_title",
							-- 	desc_id = "wolfhud_hudlist_show_aggregate_and_total_desc",
							-- 	value = {"HUDList", "RIGHT_LIST", "show_aggregate_and_total"},
							-- 	visible_reqs = {},
							-- 	enabled_reqs = {
							-- 		{ setting = { "HUDList", "ENABLED" }, invert = false },
							-- 	},
							...
							},
							{
						        ...
						        options = {
									...
									{
								        type = "toggle",
								        name_id = "wolfhud_hudlist_show_gage_packages_title",
								        desc_id = "wolfhud_hudlist_show_gage_packages_desc",
								        value = {"HUDList", "RIGHT_LIST", "SHOW_PICKUP_CATEGORIES", "gage_packages"},
								        visible_reqs = {},
								        enabled_reqs = {
									        { setting = { "HUDList", "ENABLED" }, invert = false },
									        { setting = { "HUDList", "RIGHT_LIST", "show_special_pickups" }, invert = false },
						...
						options = {
							...
							},
							{
								...
								options = {
									...
									{
										type = "toggle",
										name_id = "wolfhud_hudlist_old_sixth_sense_buff_title",
										desc_id = "wolfhud_hudlist_old_sixth_sense_buff_desc",
										value = {"HUDList", "BUFF_LIST", "GHOST_BUFFS", "old_sixth_sense"},
										visible_reqs = {},
										enabled_reqs = {
											{ setting = { "HUDList", "ENABLED" }, invert = false },
											{ setting = {"HUDList", "BUFF_LIST", "show_buffs"}, invert = false },
							...
							},
							{
								...
								options = {
									...
									{
										type = "toggle",
										name_id = "wolfhud_hudlist_armor_break_invulnerable_debuff_title",
										desc_id = "wolfhud_hudlist_armor_break_invulnerable_debuff_desc",
										value = {"HUDList", "BUFF_LIST", "PERK_BUFFS", "armor_break_invulnerable_debuff"},
										visible_reqs = {},
										enabled_reqs = {
											{ setting = { "HUDList", "ENABLED" }, invert = false },
											{ setting = {"HUDList", "BUFF_LIST", "show_buffs"}, invert = false },
			...
			{ --CustomWaypoints
				...
				options = {
					...
					{
						type = "slider",
						name_id = "wolfhud_waypoint_scale_title",
						desc_id = "wolfhud_waypoint_scale_desc",
						value = {"CustomWaypoints", "WAYPOINTS_SCALE"},
						visible_reqs = {},
						enabled_reqs = {},
						min_value = 0.5,
						max_value = 2,
			...
			{ --INTERACTION
				...
				options = {
					...
					},
					{
						...
						value = {"INTERACTION", "HIDEBAGVALUE"},
						visible_reqs = {}, enabled_reqs = {},
					},
					{
						type = "divider",
			...
			{
				type = "menu",
				menu_id = "wolfhud_menu_options_menu",
				name_id = "wolfhud_menu_options_name",
				desc_id = "wolfhud_menu_options_help",
				options = {
					{
						type = "toggle",
					...
					{
						type = "toggle",
						name_id = "wolfhud_show_custom_inv_names_title",
						desc_id = "wolfhud_show_custom_inv_names_desc",
						value = {"INVENTORY", "SHOW_CUSTOM_INVENTORY_PAGES_NAMES"},
						visible_reqs = {}, enabled_reqs = {},
					},
					{
						type = "toggle",
					...
					{
						type = "toggle",
						name_id = "FastNETENABLEDTitleID",
						desc_id = "FastNETENABLEDDescID",
						value = {"INVENTORY", "FastNETENABLED"},
						visible_reqs = {}, enabled_reqs = {},
					},
					{
						type = "toggle",
						name_id = "wolfhud_show_empty_lobby_title",
						desc_id = "wolfhud_show_empty_lobby_desc",
						value = {"INVENTORY", "SHOW_EMPTY_LOBBY"},
						visible_reqs = {}, enabled_reqs = {},
					},
					{
						type = "toggle",
						name_id = "FastNETMenuSortAlphabeticallyHeistsTitleID",
						desc_id = "FastNETMenuSortAlphabeticallyHeistsDescID",
						value = {"INVENTORY", "FastNetSortHeistsA"},
						visible_reqs = {}, enabled_reqs = {},
					},
					{
						type = "toggle",
					...
					{
						type = "toggle",
						name_id = "wolfhud_show_silent_weapons_title",
						desc_id = "wolfhud_show_silent_weapons_desc",
						value = {"INVENTORY", "SHOW_SILENT_WEAPONS"},
						visible_reqs = {}, enabled_reqs = {},
					},
					{
						type = "toggle",
						name_id = "wolfhud_hide_content_news_title",
						desc_id = "wolfhud_hide_content_news_desc",
						value = {"INVENTORY", "HiDE_CONTENT_NEWS"},
						visible_reqs = {}, enabled_reqs = {},
					},
				},
			},
			...
			{
				type = "menu",
				menu_id = "wolfhud_equipment_options_menu",
				name_id = "wolfhud_equipment_options_name",
				desc_id = "wolfhud_equipment_options_help",
				options = {
					{
						type = "toggle",
